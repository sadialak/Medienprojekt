...
/**
* Verhalten und Eigenschaften von Button Y (sobald es Instanziiert wird).
...
public class YButton : MonoBehaviour
{
	...
	*/
	...
	/**
	* Verhalten was passiert, wenn Y gedrückt wird. Dabei wird sprite zum foul verändert, der sound Y abgespielt und die Leben um 1 verringert, sollte Y 
	* zu früh gedrückt werden. Andernfalls wird das Objekt zerstört und die Punktzahl um 50 erhöht und der Y sound abgespielt.
	* kann nur einmal passieren (dafür sorgt spritezahl)
	*/
    void YTrigger(){
        if (spritezahl == 0)
