...
/**
* Verhalten und Eigenschaften von Button A (sobald es Instanziiert wird).
...
public class AButton : MonoBehaviour
{
	...
	*/
	...
	/**
	* Verhalten was passiert, wenn A gedrückt wird. Dabei wird sprite zum foul verändert, der sound A abgespielt und die Leben um 1 verringert, sollte A 
	* zu früh gedrückt werden. Andernfalls wird das Objekt zerstört und die Punktzahl um 50 erhöht und der A sound abgespielt.
	* kann nur einmal passieren (dafür sorgt spritezahl)
	*/
    void ATrigger(){
        if (spritezahl == 0)
